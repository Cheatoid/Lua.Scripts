...
-- Localized select for better performance
local select = select
...
---@param on_changed? function Callback function triggered when value changes, receives (new_value, old_value).
...
local function track_value(initial_value, fetch_value, on_changed, ...)
	...
	---@return boolean changed True if value changed, otherwise false.
