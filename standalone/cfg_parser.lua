...
--		{ name = "Multiple semicolons",                  content = ";;;;;;",                                                                                                                                                                                                                                                                                                                                                                                                              expectedCount = 0, expectError = false },
...
--		{ name = "Very long values",                     content = "\"key\" \"" .. string_rep("a", 1000) .. "\"",                                                                                                                                                                                                                                                                                                                                                                         expectedCount = 1, expectError = false },
