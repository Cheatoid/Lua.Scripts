...
oop.protected_method = oop.protectedMethod
...
oop.get_events = oop.getEvents
oop.get_event_names = oop.getEventNames
oop.get_listener_count = oop.getListenerCount
...
oop.batch_event_operations = oop.batchEventOperations
oop.get_event_stats = oop.getEventStats
oop.check_types = oop.checkTypes
oop.is_class = oop.isClass
oop.is_interface = oop.isInterface
oop.is_abstract = oop.isAbstract
oop.is_instance = oop.isInstance
oop.uses_mixin = oop.usesMixin
oop.is_mixin = oop.isMixin
oop.get_all_instances = oop.getAllInstances
oop.count_instances = oop.countInstances
oop.clear_instances = oop.clearInstances
...
oop.profile_method = oop.profileMethod
oop.to_json = oop.toJSON
oop.enable_profiling = oop.enableProfiling
oop.disable_profiling = oop.disableProfiling
oop.is_profiling_enabled = oop.isProfilingEnabled
oop.get_profile_data = oop.getProfileData
oop.clear_profile_data = oop.clearProfileData
oop.promisify_method = oop.promisifyMethod
oop.all_settled = oop.allSettled
oop.is_frozen = oop.isFrozen
oop.table_insert = oop.tableInsert
oop.table_remove = oop.tableRemove
oop.set_hook_enabled = oop.setHookEnabled
oop.set_hooks_enabled = oop.setHooksEnabled
oop.get_hook_info = oop.getHookInfo
oop.list_hooked_functions = oop.listHookedFunctions
oop.hook_before = oop.hookBefore
oop.hook_after = oop.hookAfter
oop.hook_replace = oop.hookReplace
oop.hook_around = oop.hookAround
oop.hook_method = oop.hookMethod
oop.temp_hook = oop.tempHook
oop.hook_once = oop.hookOnce
oop.hook_once_per_args = oop.hookOncePerArgs
oop.hook_when = oop.hookWhen
oop.hook_unless = oop.hookUnless
oop.hook_for_args = oop.hookForArgs
oop.hook_for_types = oop.hookForTypes
oop.hook_timer = oop.hookTimer
oop.hook_counter = oop.hookCounter
oop.hook_logger = oop.hookLogger
oop.hook_validator = oop.hookValidator
oop.hook_transformer = oop.hookTransformer
oop.hook_cache = oop.hookCache
oop.hook_debouncer = oop.hookDebouncer
oop.hook_throttler = oop.hookThrottler
oop.hook_retrier = oop.hookRetrier
oop.hook_method_once = oop.hookMethodOnce
oop.hook_method_when = oop.hookMethodWhen
oop.hook_method_logger = oop.hookMethodLogger
oop.hook_method_validator = oop.hookMethodValidator
oop.clear_all_hooks = oop.clearAllHooks
oop.deactivate_all_hooks = oop.deactivateAllHooks
oop.reactivate_all_hooks = oop.reactivateAllHooks
oop.clear_hooks = oop.clearHooks
oop.deactivate_hooks = oop.deactivateHooks
oop.reactivate_hooks = oop.reactivateHooks
oop.get_global_hook_stats = oop.getGlobalHookStats
oop.get_all_hook_ids = oop.getAllHookIds
oop.get_hooks_by_name = oop.getHooksByName
oop.cleanup_hook_registry = oop.cleanupHookRegistry
